...
def update_ema_parameters():
    with torch.no_grad():
        ...
        ema_model.load_state_dict(ema_parms, strict=True)
...
for epoch in tqdm(range(epochs)):
    ...
    if epoch % 5 == 0 and epoch != 0:
        ...
        save_ema_model_path = f'/home/liruijun/projects/Generative_models/sd/trained_models/flower_ema_{epoch}_64_l1.pth'
        print(f'saving epoch-{epoch} model to - {save_model_path}')
        torch.save(model.state_dict(), save_model_path)
        torch.save(ema_model.state_dict(), save_ema_model_path)

save_final_model_path = f'/home/liruijun/projects/Generative_models/sd/trained_models/flower_64_l1.pth'
save_final_ema_model_path = f'/home/liruijun/projects/Generative_models/sd/trained_models/flower_ema_64_l1.pth'
